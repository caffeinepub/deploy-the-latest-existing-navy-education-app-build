...
export class Backend implements backendInterface {
    ...
    async getProgress(): Promise<Array<QuizAttempt>> {
        if (this.processError) {
            try {
    ...
    async submitQuizAttempt(arg0: bigint, arg1: bigint): Promise<bigint> {
        if (this.processError) {
            try {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        rank: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.rank)),
        unit: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.unit))
    };
}
